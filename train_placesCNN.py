...
parser.add_argument('--classifier_name', default='Home',
                    help='name of the classifier')
parser.add_argument('--data', metavar='DIR', default='./dataset-place/',
...
parser.add_argument('--num_channels',default=3, type=int, help='num of img channels')
best_prec1 = 0
...
def main():
    ...
    if args.arch.lower().startswith('wideresnet'):
        ...
        model  = wideresnet.resnet50(pretrained=False, num_channels=args.num_channels, num_classes=args.num_classes)
        '''
        arch = 'resnet50'
    ...
    # Data loading code
    traindir = os.path.join(args.data, 'place_data_train/RGB/') #you may need to modify this path
    valdir = os.path.join(args.data, 'place_data_val/RGB/') #you may need to modify this path
    ...
    train_loader = torch.utils.data.DataLoader(
        ImageFolder(traindir, transform=transforms.Compose([
    ...
    val_loader = torch.utils.data.DataLoader(
        ImageFolder(valdir, transform=transforms.Compose([
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        torch.save({'epoch': epoch + 1, 'arch': args.arch, 'state_dict': model.state_dict(), 'best_prec1': best_prec1}, args.arch.lower() + '_latest.pth.tar')
        ...
        }, is_best, args.classifier_name.lower() + '_' + args.arch.lower())
